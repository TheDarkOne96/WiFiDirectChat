...
public class WiFiDirectActivity extends Activity implements ChannelListener, DeviceActionListener {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.atn_direct_discover:
                ...
                final DeviceListFragment fragment = (DeviceListFragment) getFragmentManager()
                        .findFragmentById(R.id.frag_list);
                //Display the progress dialog when pressing the search button.
                ...
                * Keep in mind that this only initiates peer discovery. The discoverPeers() method starts the discovery process and then immediately returns.
                * The system notifies you if the peer discovery process is successfully initiated by calling methods in the provided action listener.
    ...
    @Override
//    This is an implementation of DeviceActionListener that its interface is found in DeviceListFragment
//    This is to ensure the communication between this activity and the DeviceDetailFragment.
//    This will call the showDetails function that is available in DeviceDetailFragment and passing the parameter WifiP2pDevice device
//    That function will receive the Device info and update the DeviceDetailFragment Accordingly.
